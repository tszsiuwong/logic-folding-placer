...
| 层 | 单元数 | 占比 | 单元面积 | 利用率 |
|----|------:|-----:|--------:|------:|
| Die 0（底） | 159 | 53% | 839.5 M | 23.1% |
| Die 1（顶） | 142 | 47% | 877.8 M | 24.1% |
...
2D die = 44.61×40.79 µm (1819 µm²)，利用率 23.6%。3D 每 Die = 31.54×28.84 µm (909 µm²)，总 1819 µm²，上/下 Die 利用率 28%/25%，总利用率 23.6%。
