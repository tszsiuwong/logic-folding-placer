...
上 Die（Bottom）：左下 (0, 0)，右上 (63080, 57680) DBU；宽 31.54 µm，高 28.84 µm；面积 909 µm²，利用率 ~20%。  
下 Die（Top）：左下 (0, 0)，右上 (63080, 57680) DBU；宽 31.54 µm，高 28.84 µm；面积 909 µm²，利用率 ~20%。  
