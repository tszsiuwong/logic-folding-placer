...
| 2D 线长 | 网线数 | 变短 | 变长 | 平均 3D/2D |
|---|---|---|---|---|
| 0–2 µm | 51 | 11% | **86%** | 5.25 |
| 2–5 µm | 53 | 33% | **64%** | 1.91 |
| 5–10 µm | 51 | 45% | 54% | 1.31 |
| **10–20 µm** | **59** | **59%** | 40% | **0.88** |
| **20–100 µm** | **44** | **90%** | 9% | **0.60** |

**20 µm 以上的线 90% 变短；5 µm 以下的线 86% 变长。** 5-20 µm 区间为过渡带。全局 50/50 是表面现象，真实规律是：重新切层对短线是破坏性的，对长线是收益性的。
